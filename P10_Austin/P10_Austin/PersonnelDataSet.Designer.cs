...
namespace P10_Austin {
    ...
    public partial class PersonnelDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(int Id, string Name, string Position, decimal Hourly_Pay_Rate) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public decimal Hourly_Pay_Rate {
                get {
                    try {
                        return ((decimal)(this[this.tableTable.Hourly_Pay_RateColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Hourly Pay Rate\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.Hourly_Pay_RateColumn] = value;
                }
            }
            ...
            public bool IsHourly_Pay_RateNull() {
                return this.IsNull(this.tableTable.Hourly_Pay_RateColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetHourly_Pay_RateNull() {
                this[this.tableTable.Hourly_Pay_RateColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace P10_Austin.PersonnelDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Position = 1 AND [Position] IS NULL) OR ([Position] = @Original_Position)) AND ((@IsNull_Hourly_Pay_Rate = 1 AND [Hourly Pay Rate] IS NULL) OR ([Hourly Pay Rate] = @Original_Hourly_Pay_Rate)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_Hourly_Pay_Rate", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Hourly Pay Rate", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Name], [Position], [Hourly Pay Rate]) VALUES (@" +
                "Id, @Name, @Position, @Hourly_Pay_Rate);\r\nSELECT Id, Name, Position, [Hourly Pay" +
                " Rate] FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Name] = @Name, [Position] = @Position, [Hourly Pay Rate] = @Hourly_Pay_Rate WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Position = 1 AND [Position] IS NULL) OR ([Position] = @Original_Position)) AND ((@IsNull_Hourly_Pay_Rate = 1 AND [Hourly Pay Rate] IS NULL) OR ([Hourly Pay Rate] = @Original_Hourly_Pay_Rate)));
SELECT Id, Name, Position, [Hourly Pay Rate] FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_Hourly_Pay_Rate", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Hourly Pay Rate", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::P10_Austin.Properties.Settings.Default.PersonnelConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Position, [Hourly Pay Rate] FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Position, global::System.Nullable<decimal> Original_Hourly_Pay_Rate) {
            ...
            if ((Original_Hourly_Pay_Rate.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[5].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[6].Value = ((decimal)(Original_Hourly_Pay_Rate.Value));
            }
            else {
        ...
        public virtual int Insert(int Id, string Name, string Position, global::System.Nullable<decimal> Hourly_Pay_Rate) {
            ...
            if ((Hourly_Pay_Rate.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((decimal)(Hourly_Pay_Rate.Value));
            }
            else {
        ...
        public virtual int Update(int Id, string Name, string Position, global::System.Nullable<decimal> Hourly_Pay_Rate, int Original_Id, string Original_Name, string Original_Position, global::System.Nullable<decimal> Original_Hourly_Pay_Rate) {
            ...
            if ((Hourly_Pay_Rate.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((decimal)(Hourly_Pay_Rate.Value));
            }
            else {
            ...
            if ((Original_Hourly_Pay_Rate.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((decimal)(Original_Hourly_Pay_Rate.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Position, global::System.Nullable<decimal> Hourly_Pay_Rate, int Original_Id, string Original_Name, string Original_Position, global::System.Nullable<decimal> Original_Hourly_Pay_Rate) {
            return this.Update(Original_Id, Name, Position, Hourly_Pay_Rate, Original_Id, Original_Name, Original_Position, Original_Hourly_Pay_Rate);
        }
    }
